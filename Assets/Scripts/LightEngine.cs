...
public class LightEngine : MonoBehaviour
{
    ...
    {
        _illuminations.Add(source, CreateSourceMesh(illumination, lightMat));
        _shadows.Add(source, CreateSourceMesh(shadows, shadowMat));
    }

    private Mesh CreateSourceMesh(Transform parent, Material material)
    {
    ...
    {
        UnregisterSource(_illuminations, source);
        UnregisterSource(_shadows, source);
    }

    private static void UnregisterSource(Dictionary<LightSource, Mesh> dict, LightSource key, bool clearGeometry = true)
    {
